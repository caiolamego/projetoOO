...
public class Dados {
	private UsuarioConsumidor[] ususariosConsumidor;
	private int nAlunos = 0;
	private UsuarioEmpresa[] usuariosEmpresa;
	private int nProfs = 0;
	private Reclamacao[] reclamacoes;
	...
	public void preencherDados() {
		for (int i = 0; i < 10; i++) {
			...
			alunos[i] = new Aluno("Aluno".concat(s), "id".concat(s), "cpf".concat(s), "telefone".concat(s),
					"dataNascimento".concat(s), "endereco".concat(s));
			professores[i] = new Professor("Professor".concat(s), "id".concat(s), "cpf".concat(s), "telefone".concat(s),
					i);
